...
cd candida_albicans
wget -N ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA_000149445.2_ASM14944v2/*.genomic.fna.gz &
wget -N ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA_000149445.2_ASM14944v2/*.protein.faa.gz &
...
wget -N ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF_000151425.1_ASM15142v1/*.genomic.fna.gz
wget -N ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF_000151425.1_ASM15142v1/*.protein.faa.gz
